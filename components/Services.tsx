...
const Services: React.FC = () => {
  ...
  return (
    <section id="servicos" className="py-20 bg-surface-light relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          ...
          >
            ...
            <h2 className="font-display text-4xl text-gray-900 font-bold mt-2">Meus Serviços</h2>
          </motion.div>
          <motion.div 
            initial={{ scaleX: 0 }}
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                <h3 className="font-display text-2xl font-bold text-gray-900 mb-4">{service.title}</h3>
                <p className="text-gray-600 mb-6 flex-grow leading-relaxed">
                  {service.desc}
                </p>
                <a 
                  href="#" 
                  className={`inline-flex items-center font-bold transition-colors ${service.btnColor} group`}
                >
