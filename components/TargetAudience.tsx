  ...
  return (
    <section id="para-quem" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display text-4xl text-gray-900 font-bold mb-4">Para quem é este espaço?</h2>
        ...
        >
          {cards.map((card, index) => (
            <motion.div 
              key={index}
              variants={item}
              className="bg-surface-light p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 text-center group cursor-default"
            >
